...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    is_reader = serializers.ChoiceField(choices=User_TYPES,required=True,label='What are you?')
    ...
    class Meta:
        model = User
        fields = ('username', 'password', 'password2', 'email', 'first_name', 'last_name','gender','country','is_reader')
        extra_kwargs = {
